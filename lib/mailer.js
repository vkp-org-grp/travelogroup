...
export function getTransporter() {
  if (!transporter) {
    transporter = nodemailer.createTransport({
      ...
      // Reuse authenticated connections across sends instead of paying a
      // fresh TCP+TLS+AUTH handshake with Zoho for every single email —
      // this is what made each form submission feel slow.
      pool: true,
      maxConnections: 3,
    });
  }
